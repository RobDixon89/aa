  ...
  children: (
    <>
      <p>
        ...
        tortor, pulvinar eu ullamcorper sed, consectetur non turpis. Maecenas in{" "}
        <a href="#">nunc pulvinar</a>, rutrum mi sit amet, dignissim nibh.
        Vestibulum lobortis eros et massa fermentum, non volutpat ipsum mollis.
        Pellentesque faucibus sed diam nec placerat. Nunc convallis, lectus at
        ultrices finibus, velit dui euismod ligula, sed condimentum lectus metus
        a nisl.
      </p>
      ...
      <p>
        Praesent pharetra magna nibh, eget hendrerit lorem ullamcorper et. Etiam
        odio purus, ultricies id varius in, posuere eleifend dolor. Aliquam in
        turpis eu nulla faucibus vestibulum. Praesent commodo ex nec rutrum
        dignissim. Ut imperdiet vitae diam et efficitur. Nulla facilisi. Etiam
        non elit urna. Interdum et malesuada fames ac ante ipsum primis in
        faucibus. Ut at dapibus eros, in posuere lectus.
      </p>
  ...
  children: (
    <>
      ...
      <p>
        ...
        pharetra. Vestibulum erat wisi, condimentum sed, ornare sit amet, wisi.
        Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum
        orci, sagittis tempus lacus enim ac dui. <a href="#">Donec non enim</a>{" "}
        in turpis pulvinar facilisis. Ut felis.
      </p>

      <p className="subtitle">Small Text</p>
      <p className="jhhkjgj small">
        Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
        et dolore magna aliqua.Donec eleifend, libero at sagittis mollis, tellus
        est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus
        pretium ornare est.
      </p>

      <p className="subtitle">Large Text</p>
      <p className="jhhkjgj large">
        Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
        et dolore magna aliqua.Donec eleifend, libero at sagittis mollis, tellus
        est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus
        pretium ornare est.
